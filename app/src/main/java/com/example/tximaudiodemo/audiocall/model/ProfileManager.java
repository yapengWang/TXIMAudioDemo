...
public class ProfileManager {
    ...
    public void login(String userId, String head, String userName, String userSig, final ActionCallback callback) {
        isLogin = true;
        setUserId(userId);
        UserModel userModel = new UserModel();
        userModel.userId = userId;
        userModel.userAvatar = head;
    ...
    public void autoLogin(String userId, String head, String userName, String userSig,  final ActionCallback callback) {
        isLogin = true;
        setUserId(userId);
        UserModel userModel = new UserModel();
        userModel.userAvatar = head;
